...
//	
//	Возврат ОбщегоНазначения.ВнутренняяWSПрокси(ОбщегоНазначения.ЗначениеИзСтрокиXML(Параметры));
//	
//КонецФункции
...
Функция ЗначениеДополнительнойКонстанты(ИмяКонстанты, ВозвращатьКакМассив = Ложь, ВызыватьИсключение = Истина) Экспорт
	...
	Возврат ОбщегоНазначенияВызовСервера.ЗначениеДополнительнойКонстанты(ИмяКонстанты, ВозвращатьКакМассив, ВызыватьИсключение);
